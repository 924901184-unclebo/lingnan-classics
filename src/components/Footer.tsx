...
export function Footer() {
  ...
  return (
    <footer
      ...
      style={{ background: '#1a2228', borderTop: '1px solid rgba(255,255,255,0.06)' }}
    >
      <div className="max-w-[1400px] 2xl:max-w-[1600px] 3xl:max-w-[1800px] mx-auto">
        ...
        >
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12 pb-12" style={{ borderBottom: '1px solid rgba(255,255,255,0.06)' }}>
            ...
            <div>
              <h4 className="text-xs font-sans tracking-wider mb-4" style={{ color: 'rgba(246,243,237,0.45)' }}>
                平台
              </h4>
              <ul className="space-y-2.5">
                {['典籍馆藏', '知识图谱', 'AI智能体', '数字文物', '专题展览'].map((item) => (
                  <li key={item}>
                    <a href="#" className="text-sm font-sans transition-colors hover:opacity-70" style={{ color: 'rgba(246,243,237,0.3)' }}>
                      {item}
                    </a>
                  </li>
                ))}
