  ...
  return (
    ...
    >
      <div className="max-w-[1400px] mx-auto">
        ...
        >
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12 pb-12" style={{ borderBottom: '1px solid rgba(255,255,255,0.04)' }}>
            ...
            <div>
              <h4 className="text-xs font-sans tracking-wider mb-4" style={{ color: 'rgba(246,243,237,0.4)' }}>
                平台
              </h4>
              <ul className="space-y-2.5">
                {['典籍馆藏', '知识图谱', 'AI智能体', '数字文物', '专题展览'].map((item) => (
                  <li key={item}>
                    <a href="#" className="text-sm font-sans transition-colors hover:opacity-70" style={{ color: 'rgba(246,243,237,0.25)' }}>
                      {item}
                    </a>
                  </li>
                ))}
          ...
          <div className="pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-6">
              {['隐私政策', '使用条款', '开放API'].map(link => (
                <a key={link} href="#" className="text-[11px] font-sans transition-colors hover:opacity-70" style={{ color: 'rgba(246,243,237,0.2)' }}>
                  {link}
                </a>
              ))}
            </div>
