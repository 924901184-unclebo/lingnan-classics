    ...
    >
      <div className="max-w-[800px] 2xl:max-w-[960px] mx-auto">
        ...
        >
          ...
          <p className="text-sm font-sans mt-2" style={{ color: 'rgba(246,243,237,0.4)' }}>
        ...
        >
          <div className="flex items-center rounded-lg px-4 py-3.5 backdrop-blur-sm" style={{
            ...
            <Search size={18} style={{ color: 'rgba(201,169,110,0.7)' }} />
            <input
              type="text"
              value={query}
            ...
            />
            <button style={{ color: 'rgba(246,243,237,0.35)' }}>
          ...
          {query && (
            ...
            >
              {searchResults.map((result, i) => (
                <div
                  key={i}
                  className="px-4 py-3 cursor-pointer transition-colors hover:bg-[rgba(255,255,255,0.04)]"
                ...
                >
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      ...
                      <span className="text-sm font-serif" style={{ color: 'rgba(246,243,237,0.85)' }}>
                        {result.title}
                      </span>
                    </div>
                    <span className="text-[10px] font-sans" style={{ color: 'rgba(246,243,237,0.3)' }}>
                      {result.dynasty}
                    </span>
                  </div>
                  <p className="text-[11px] font-sans mt-1 ml-[52px]" style={{ color: 'rgba(246,243,237,0.4)' }}>
                    {result.match}
                  </p>
                </div>
              ))}
